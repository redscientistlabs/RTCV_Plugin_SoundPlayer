...
namespace SOUNDPLAYER
{
    ...
    public class SOUNDPLAYER : IPlugin, IDisposable
    {
        //-------[ Plugin metadata ]-------

        // >>> Make sure you rename BOTH the namespace and class (Very important)
        public string Description => "Play sound effects from netcore commands";
        ...
        public string Name => nameof(SOUNDPLAYER).Replace("_"," ");
